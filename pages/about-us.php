...
<div class="container mx-auto px-4 py-8">
    ...
    <!-- Decorative elements for sections without images -->
    <section class="mb-6 bg-gray-100 p-4 rounded-lg shadow mx-auto w-full md:w-3/4 lg:w-3/4">
